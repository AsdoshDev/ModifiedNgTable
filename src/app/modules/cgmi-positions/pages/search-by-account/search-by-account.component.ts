...
@Component({
  selector: 'search-by-account',
  templateUrl: './search-by-account.component.html',
  styleUrls: ['./search-by-account.component.css']
})
export class SearchByAccountComponent implements OnInit {
  ...
  ngOnInit() {
    this.tabs = [
      ...
      { title: 'Positions by Account', id: 'pba' }
    ];
    this.searchTabs = [
