...
@Component({
  selector: 'search-by-security',
  templateUrl: './search-by-security.component.html',
  styleUrls: ['./search-by-security.component.css']
})
export class SearchBySecurityComponent implements OnInit {
